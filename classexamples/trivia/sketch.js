...
// use -1 becasue buttons starts at "0" and -1 means that the user has not pressed any of the buttons yet; at the point the user makes a selection, then it goes into the other numbers
...
function draw() {
  ...
  // != the oposite of ==; if the currentOption is not equal to -1
  if(currentOption != -1){
